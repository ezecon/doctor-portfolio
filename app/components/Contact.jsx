        ...
        <div className="min-h-screen flex flex-col items-center justify-center font-mono">
          <div className="container mx-auto p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="w-full">
                      <div className="w-full md:w-4/5 text-center rounded-lg flex items-center mb-8">
                        ...
                        <div className="contact-info  ml-4">
                          <h2 className="text-sm md:text-lg leading-6 font-medium">+880 1000000000</h2>  
                          <h2 className="text-sm md:text-lg leading-6 font-medium">+880 1000000000</h2>
                        </div>
                      </div>
                      ...
                      <div className="w-full md:w-4/5 text-center rounded-lg flex items-center mb-8">
                        ...
                        <div className="contact-info ml-4">
                          <h2 className="text-sm md:text-lg leading-6 font-medium">drpriom88@gmail.com</h2>
                        </div>
                      </div>
                      <div className="w-full md:w-4/5 text-center rounded-lg flex items-center mb-8">
                        <div className="w-12">
                        ...
                        <div className="text-left contact-info ml-4">
                          <h2 className="text-sm md:text-lg leading-6 font-medium">Classic Consultation & Diagnostic Center</h2>
                          <h2 className="text-sm md:text-lg leading-6 font-medium">Sadar Hospital Road, Cumill</h2>
                          <h2 className="text-sm md:text-lg leading-6 font-medium">Lab One Diagnostic Center</h2>
                          <h2 className="text-sm md:text-lg leading-6 font-medium">Sadar Hospital Road, Cumilla</h2>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="text-[goldenrod]">
                <h2 className="text-lg md:text-xl font-semibold mb-4">Write me your questions</h2>
                <form className="space-y-4" onSubmit={sendEmail}>
                  ...
                  <div>
                    <label htmlFor="project" className="block">Question</label>
                    <textarea
                      id="project"
